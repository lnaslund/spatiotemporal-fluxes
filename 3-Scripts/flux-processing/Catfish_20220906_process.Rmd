---
title: "Catfish_20220906_process"
author: "L. Naslund"
date: "2022-09-22"
...
flux_files <- file.finder(data.path = "../../1-Raw Data/flux", start="2022-09-06", end= "2022-09-07", type="flux")
temp_files <- file.finder(data.path = "../../1-Raw Data/flux", start="2022-09-06", end= "2022-09-07", type="temperature")

data <- read.flux(flux_files, "America/New_York")

times <-read.csv("../../1-Raw Data/flux/2022-09-06/Catfish_20220906_times.csv") %>% filter(is.na(Start)==FALSE, is.na(End)==FALSE, Start!="", End!="") %>% mutate(Start= mdy_hms(paste(Date, Start, sep=" "), tz="America/New_York"), End= mdy_hms(paste(Date, End, sep= " "), tz="America/New_York")) 
```
...
pdf("../../1-Raw Data/flux/flux_plots/Catfish_20220906_ch4_plots.pdf", paper="a4", width=9, height=12)
marrangeGrob(grobs=compact(flux_list$ch4_plot), nrow=3, ncol=2)
dev.off()
# 
pdf("../../1-Raw Data/flux/flux_plots/Catfish_20220906_co2_plots.pdf", paper="a4", width=9, height=12)
...
file_name <- "../../1-Raw Data/flux/processed-flux/Catfish_20220906_Fluxes.csv"
write.csv(fluxes, file_name , row.names = F)
```

```{r add vol calc}
# calculation of additional volume added by the tubing 
