---
title: "Sister 3 2022-08-22 Process"
author: "L. Naslund"
date: "2022-08-26"
...
flux_files <- file.finder(data.path = "../../1-Raw Data/flux", start="2022-08-22", end= "2022-08-23", type="flux")
temp_files <- file.finder(data.path = "../../1-Raw Data/flux", start="2022-08-22", end= "2022-08-23", type="temperature")

data <- read.flux(flux_files, "America/New_York")

times <-read.csv("../../1-Raw Data/flux/2022-08-22/Sisters3_20220822_times.csv") %>% filter(is.na(Start)==FALSE, is.na(End)==FALSE, Start!="", End!="") %>% mutate(Start= mdy_hms(paste(Date, Start, sep=" "), tz="America/New_York"), End= mdy_hms(paste(Date, End, sep= " "), tz="America/New_York")) 
```
...
pdf("../../1-Raw Data/flux/flux_plots/Sister3_20220822_ch4_plots.pdf", paper="a4", width=9, height=12)
marrangeGrob(grobs=compact(flux_list$ch4_plot), nrow=3, ncol=2)
dev.off()
# 
pdf("../../1-Raw Data/flux/flux_plots/Sister3_20220822_co2_plots.pdf", paper="a4", width=9, height=12)
...
file_name <- "../../1-Raw Data/flux/processed-flux/Sister3_20220822_Fluxes.csv"
