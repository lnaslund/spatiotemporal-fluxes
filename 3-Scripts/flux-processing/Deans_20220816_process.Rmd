---
title: "Deans 2022-08-16 Process"
author: "L. Naslund"
date: "2022-08-26"
...
flux_files <- file.finder(data.path = "../../1-Raw Data/flux", start="2022-08-16", end= "2022-08-17", type="flux")
temp_files <- file.finder(data.path = "../../1-Raw Data/flux", start="2022-08-16", end= "2022-08-17", type="temperature")

data <- read.flux(flux_files, "America/New_York")

times <-read.csv("../../1-Raw Data/flux/2022-08-16/Deans_20220816_times.csv") %>% filter(is.na(Start)==FALSE, is.na(End)==FALSE, Start!="", End!="") %>% mutate(Start= mdy_hms(paste(Date, Start, sep=" "), tz="America/New_York"), End= mdy_hms(paste(Date, End, sep= " "), tz="America/New_York")) 
```
...
pdf("../../1-Raw Data/flux/flux_plots/Deans_20220816_ch4_plots.pdf", paper="a4", width=9, height=12)
marrangeGrob(grobs=compact(flux_list$ch4_plot), nrow=3, ncol=2)
dev.off()
# 
pdf("../../1-Raw Data/flux/flux_plots/Deans_20220816_co2_plots.pdf", paper="a4", width=9, height=12)
...
temp_add <- data.frame(date_time = seq(ymd_hms("2022-08-16 16:06:13", tz = "America/New_York"), ymd_hms("2022-08-16 16:34:13", tz = "America/New_York"), by = "sec"), temp = 39.79, temp_k = 312.94)

temp_data <- rbind(temp_data, temp_add)
...
file_name <- "../../1-Raw Data/flux/processed-flux/Deans_20220816_Fluxes.csv"
write.csv(fluxes, file_name , row.names = F)
```

```{r}
# calculation additional volume from tubing
