---
title: "Catfish_20220918_process"
author: "L. Naslund"
date: "2022-09-26"
...
flux_files <- file.finder(data.path = "../../1-Raw Data/flux", start="2022-09-18", end= "2022-09-19", type="flux")
temp_files <- file.finder(data.path = "../../1-Raw Data/flux", start="2022-09-18", end= "2022-09-19", type="temperature")

data <- read.flux(flux_files, "America/New_York")

times <-read.csv("../../1-Raw Data/flux/2022-09-18/Catfish_20220918_times.csv") %>% filter(is.na(Start)==FALSE, is.na(End)==FALSE, Start!="", End!="") %>% mutate(Start= mdy_hms(paste(Date, Start, sep=" "), tz="America/New_York"), End= mdy_hms(paste(Date, End, sep= " "), tz="America/New_York")) 
```
...
pdf("../../1-Raw Data/flux/flux_plots/Catfish_20220918_ch4_plots.pdf", paper="a4", width=9, height=12)
marrangeGrob(grobs=compact(flux_list$ch4_plot), nrow=3, ncol=2)
dev.off()
# 
pdf("../../1-Raw Data/flux/flux_plots/Catfish_20220918_co2_plots.pdf", paper="a4", width=9, height=12)
...
# lost first three flux chamber temps so set equal to average of next three flux measurements
flux_list_corrected$temperature[1:3] <- mean(c(300.2094, 298.2686, 297.4931))
...
file_name <- "../../1-Raw Data/flux/processed-flux/Catfish_20220918_Fluxes.csv"
write.csv(fluxes, file_name , row.names = F)
```

```{r}
# calculate additional volume added by the tubing
